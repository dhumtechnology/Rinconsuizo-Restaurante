...
class EnviarSunatModel {
    ...
    public function obtenerDatosVentaPorIdVenta($id_venta){
        try
        {
            $stm = $this->conexionn->prepare("SELECT * FROM ventas where idventa = ?");
    ...
    public function listarDetalleVenta($cod_vent)
    {
        ...
        {
            $cod = $cod_vent;
            $stm = $this->conexionn->prepare("SELECT * FROM detalleventas WHERE idventa = ? ");
...
$fac_ele = $reg[0]['fac_ele'];
$clave = $reg[0]['clave'];
$nombre_empresa = $reg[0]['nomempresa'];
$departamento = "SAN MARTIN";
$provincia = "SAN MARTIN";
$distrito = "TARAPOTO";
$ruc1 = $reg[0]['rifempresa'];
$direccion = $reg[0]['direcempresa'];
...
<body>
    ...
    <script>
        ...
        function load(id){
            ...
            ?>
            var link = '../../../reportepdf?codventa='+<?php echo base64_encode($id_venta);?>+'&tipo='+base64_encode('TICKET');?>;
