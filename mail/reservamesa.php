        ...
        <tr height='80'>
         ...
         <h4>RESTAURANTE EL RINCON SUIZO</h4>
          ...
          <p style='font-size: 16px;font-family: Verdana, Geneva, sans-serif;background-color: #333f50;color: white;text-align: center; font-weight: 200;padding: 15px;border-radius: 10px;'> <?php echo $full_name; ?></p>
           ...
           <td  colspan='2' style='width: 60%' ><p style='font-size: 14px;font-family: Verdana, Geneva, sans-serif;background-color: white;color: #7d8181;text-align: center; font-weight: 200;padding: 5px;border-radius: 5px;border: 1px solid #547386;margin-left: 3px;'> <?php echo $_POST["cantidad"]; ?></p></td>
          </tr>
          <tr align='center' height='50' style='font-family:Verdana, Geneva, sans-serif;' style="width: 100%;">
           ...
           <td  colspan='2' style='width: 60%' ><p style='font-size: 14px;font-family: Verdana, Geneva, sans-serif;background-color: white;color: #7d8181;text-align: center; font-weight: 200;padding: 5px;border-radius: 5px;border: 1px solid #547386;margin-left: 3px;'> <?php echo $_POST["fecha"].' '.$_POST["hora"]; ?></p></td>
          </tr>
          <tr align='center' height='50' style='font-family:Verdana, Geneva, sans-serif;' style="width: 100%;">
