...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Créditos por Fechas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="carteracreditos">Control</a></li>
<li class="active">Créditos por Fechas</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="creditosfechas" id="creditosfechas">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Créditos por Fechas</h3></div>
...
<button type="button" onClick="BuscaCreditosFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
                                    </div><!-- /.box-body -->
								</div>
                          </div>
						        ...
						        <div id="muestracreditosfechas"></div>
						          </form>
           </div>
       </div>
</div>
