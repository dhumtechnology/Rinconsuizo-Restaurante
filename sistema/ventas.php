...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Ventas</h4>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Búsqueda de Ventas</h3></div>
<div class="panel-body">
...
<select name="tipobusqueda" id="tipobusqueda" class="form-control" tabindex="1" required="" aria-required="true">
...
<input class="form-control" type="text" name="busquedacliente" id="busquedacliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Criterio de Búsqueda" required="required">
...
<input class="form-control calendario" type="text" name="fecha" id="fecha" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha de Venta" tabindex="2" required="" aria-required="true">
                    ...
                    <div class="modal-footer"> 
<button type="button" onClick="BuscarVentas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>      
                          </div>
