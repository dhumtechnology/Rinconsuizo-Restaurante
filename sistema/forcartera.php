...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Créditos</h4>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="abonoscreditos" id="abonoscreditos">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Créditos</h3></div>
...
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			 ...
			 <?php
        $arqueocredito = new Login();
        $arqueocredito = $arqueocredito->VerificaArqueoCreditos();
        ?>	
								...
								<div id="muestraclientesabonos"></div>	
						    <div id="muestraformularioabonos"></div>
						          </form>
           </div>
       </div>
</div>
