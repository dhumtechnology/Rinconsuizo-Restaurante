...
<form class="form" name="updatecajas" id="updatecajas" method="post" data-id="<?php echo $reg[0]["codcaja"] ?>" action="#">
  ...
  <input type="hidden" name="codcaja" id="codcaja" <?php if (isset($reg[0]['codcaja'])) { ?> value="<?php echo $reg[0]['codcaja']; ?>"<?php } ?>>
	  <input type="text" class="form-control" name="nrocaja" id="nrocaja" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese N° de Caja" <?php if (isset($reg[0]['nrocaja'])) { ?> value="<?php echo $reg[0]['nrocaja']; ?>"<?php } ?> required="" aria-required="true">
  ...
  <input type="text" class="form-control" name="nombrecaja" id="nombrecaja" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Caja" <?php if (isset($reg[0]['nombrecaja'])) { ?> value="<?php echo $reg[0]['nombrecaja']; ?>"<?php } ?> required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>  
                              </div> 
                        </div> 
