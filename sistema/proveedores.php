...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
              <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos del Proveedor</h3> 
                                                        </div> 
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Proveedores</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Proveedores</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Proveedores<span class="pull-right">
...
<li><a href="forproveedor" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Proveedor"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("PROVEEDORES") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?tipo=<?php echo base64_encode("PROVEEDORES") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3>
</div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<span class='fa fa-check-square-o'></span> EL CLIENTE FUE ELIMINADO EXITOSAMENTE</center>";
        echo "</div>";  
		break;
		...
		echo "<center><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<span class='fa fa-info-circle'></span> ESTE CLIENTE NO PUEDE SER ELIMINADO, TIENE VENTAS ASOCIADAS ACTUALMENTE</center>";
        echo "</div>";   
		break;
...
?>
 ...
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Proveedor" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerProveedor('<?php echo base64_encode($reg[$i]["codproveedor"]); ?>')"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Proveedor" onClick="actualizar('forproveedor?codproveedor=<?php echo base64_encode($reg[$i]["codproveedor"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Proveedor" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codproveedor=<?php echo base64_encode($reg[$i]["codproveedor"]) ?>&tipo=<?php echo base64_encode("PROVEEDORES") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
