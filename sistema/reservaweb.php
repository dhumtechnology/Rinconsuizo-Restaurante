...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Listado de reservas de la web</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Reservas desde web</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Reservas de mesas<span class="pull-right"></span></h3></div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA RESERVA HA SIDO ELIMINADA </center>";
        echo "</div>";  
		break;
		...
		echo "<span class='fa fa-info-circle'></span> NO TIENE ACCESO</center>"; 
        echo "</div>";  
		break;
