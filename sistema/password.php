...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Cambio de Contraseña</h4>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-unlock-alt"></i> Cambio de Contraseña</h3></div>
...
<input name="usuario" class="form-control" type="text" id="usuario" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Usuario de Acceso" autocomplete="off" value="<?php echo $_SESSION['usuario']; ?>" required="" aria-required="true"/>
                        <i class="fa fa-user form-control-feedback"></i>   
                            ...
                            <div class="col-md-3"> 
                               <div class="form-group has-feedback"> 
      <label class="control-label">Ingrese Nuevo Password: <span class="symbol required"></span></label> 
...
<button type="submit" name="btn-update" id="btn-update" class="btn btn-primary waves-effect waves-light"><span class="fa fa-edit"></span> Actualizar</button>
<button type="reset" class="btn btn-danger waves-effect waves-light"><i class="fa fa-times-circle"></i> Cancelar</button>
		    </div>
                                </form>
                                    </div><!-- /.box-body -->
								</div>
