...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
                <h3 class="panel-title"><i class="fa fa-align-justify"></i> Detalle de Crédito</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestracreditosmodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Créditos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Créditos</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Créditos</h3>
</div>
...
<td><?php echo "<strong>".$config[0]['simbolo']."</strong>".number_format($reg[$i]['totalpago'], 2, '.', ','); ?></td>
<td><?php echo "<strong>".$config[0]['simbolo']."</strong>".number_format($reg[$i]['abonototal'], 2, '.', ','); ?></td>
<td><?php echo "<strong>".$config[0]['simbolo']."</strong>".number_format($reg[$i]["totalpago"]-$reg[$i]["abonototal"], 2, '.', ','); ?></td>
											   <td>
<a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Detalle de Crédito" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerCreditos('<?php echo base64_encode($reg[$i]["codventa"]); ?>')"><i class="fa fa-search-plus"></i></a>

<a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("TICKETCREDITOS") ?>" target="_black" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Ticket de Crédito" ><i class="fa fa-print"></i></a></td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
