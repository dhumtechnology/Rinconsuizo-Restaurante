...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Categorias</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Categorias</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Categorias<span class="pull-right"><a href="forcategoria" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Categoria"><span class="fa fa-plus"></span> Nueva</a></span></h3></div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA CATEGORIA DE PRODUCTO FUE ELIMINADA EXITOSAMENTE </center>";
        echo "</div>";  
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTA CATEGORIA NO PUEDE SER ELIMINADA, TIENE PRODUCTOS ASOCIADOS ACTUALMENTE </center>";
        echo "</div>";   
		break;
...
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Categoria" onClick="actualizar('forcategoria?codcategoria=<?php echo base64_encode($reg[$i]["codcategoria"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Categoria" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcategoria=<?php echo base64_encode($reg[$i]["codcategoria"]) ?>&tipo=<?php echo base64_encode("CATEGORIAS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
