...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de M. de Pago</h4>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Medios Pagos<span class="pull-right"><a href="formediopago" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Medio de Pago"><span class="fa fa-plus"></span> Nuevo</a></span></h3></div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> EL MEDIO DE PAGO FUE ELIMINADO EXITOSAMENTE </center>";
        echo "</div>";  
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTE MEDIO DE PAGO NO PUEDE SER ELIMINADO, TIENE VENTAS ASOCIADOS ACTUALMENTE </center>";
        echo "</div>";   
		break;
...
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar M. de Pago" onClick="actualizar('formediopago?codmediopago=<?php echo base64_encode($reg[$i]["codmediopago"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar M. de Pago" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codmediopago=<?php echo base64_encode($reg[$i]["codmediopago"]) ?>&tipo=<?php echo base64_encode("MEDIOPAGO") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
