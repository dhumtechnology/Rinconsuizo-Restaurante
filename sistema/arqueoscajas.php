...
<a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Arqueo de Caja" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerArqueo('<?php echo $reg[$i]["codarqueo"]; ?>')"><i class="fa fa-search-plus"></i></a>
