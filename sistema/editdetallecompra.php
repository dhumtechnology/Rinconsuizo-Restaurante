...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Detalle de Compra</h4>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Detalle de Compra Nº <?php echo $reg[0]['codcompra']; ?></h3></div>
...
<div id="cargacomprainput"><input type="hidden" name="cantidadcompradb" id="cantidadcompradb" value="<?php echo $reg[0]['cantcompra']; ?>" ></div>
