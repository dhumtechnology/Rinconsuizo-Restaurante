...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Movimientos en Cajas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="movimientos">Control</a></li>
<li class="active">Movimientos en Cajas</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post" action="#" name="buscamovimientosfechas" id="buscamovimientosfechas">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Movimientos en Cajas</h3></div>
...
<button type="button" onClick="BuscaMovimientosCajasFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
                                    </div><!-- /.box-body -->
								</div>
                          </div>
						        ...
						        <div id="muestramovimientosfechas"></div>
						          </form>
           </div>
       </div>
</div>
