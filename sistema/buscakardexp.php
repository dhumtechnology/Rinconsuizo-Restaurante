...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="buscakardex" id="buscakardex">
    ...
    <div class="row"> 
      ...
      <div class="col-md-12"> 
       <div class="form-group has-feedback"> 
        <label class="control-label">Búsqueda de Productos: <span class="symbol required"></span></label>
        <input type="hidden" class="form-control" name="codproducto" id="codproducto">
        <input class="form-control" type="text" name="busquedaproducto" id="busquedaproducto" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la b&uacute;squeda de Productos" required="required">
