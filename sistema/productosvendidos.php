...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Búsqueda de Productos Vendidos</h4>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post" action="#" name="buscaproductosfechas" id="buscaproductosfechas">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Búsqueda de Productos Vendidos</h3></div>
...
<button type="button" onClick="BuscaProductoVendidosFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
                                    </div><!-- /.box-body -->
								</div>
                          </div>
						        ...
						        <div id="muestraproductosfechas"></div>
						          </form>
           </div>
       </div>
</div>
