...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Compras por Proveedor</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="compras">Control</a></li>
<li class="active">Compras por Proveedor</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="buscacomprasproveedor" id="buscacomprasproveedor">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Compras por Proveedor</h3></div>
...
<button type="button" onClick="BuscaComprasProveedor()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
						        ...
						        <div id="muestracompraproveedor"></div>
						          </form>
           </div>
       </div>
</div>
