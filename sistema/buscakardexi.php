...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Búsqueda de Kardex</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="kardexproductos">Control</a></li>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="buscakardexingrediente" id="buscakardexingrediente">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Búsqueda de Kardex</h3></div>
    ...
    <div class="row"> 
      ...
      <div class="col-md-12"> 
       <div class="form-group has-feedback"> 
        <label class="control-label">Búsqueda de Ingredientes: <span class="symbol required"></span></label>
        <input type="hidden" class="form-control" name="codingrediente" id="codingrediente">
        <input class="form-control" type="text" name="busqueda" id="busqueda" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la b&uacute;squeda de Ingredientes" required="required">
...
<button type="button" onClick="BuscaKardexIngredientes()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
								...
								<div id="muestrakardexingrediente"></div>	
						          </form>
           </div>
       </div>
</div>
