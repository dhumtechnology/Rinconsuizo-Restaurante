...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Salas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Salas</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Salas<span class="pull-right"><a href="forsala" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Sala"><span class="fa fa-plus"></span> Nueva</a></span></h3></div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA SALA FUE ELIMINADA EXITOSAMENTE </center>";
        echo "</div>";  
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTA SALA NO PUEDE SER ELIMINADA, TIENE MESAS ASOCIADAS ACTUALMENTE </center>";  
        echo "</div>"; 
		break;
...
?>
                                               ...
                                               <td><?php echo $reg[$i]['salacreada']; ?></td>
											   <td>
 
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Sala" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerSala('<?php echo base64_encode($reg[$i]["codsala"]); ?>')"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Sala" onClick="actualizar('forsala?codsala=<?php echo base64_encode($reg[$i]["codsala"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Sala" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codsala=<?php echo base64_encode($reg[$i]["codsala"]) ?>&tipo=<?php echo base64_encode("SALAS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
