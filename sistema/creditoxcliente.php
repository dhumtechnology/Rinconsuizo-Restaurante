...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Créditos por Clientes</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="carteracreditos">Control</a></li>
<li class="active">Créditos por Clientes</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="creditosclientes" id="creditosclientes">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Créditos por Clientes</h3></div>
...
<input type="hidden" class="form-control" name="codcliente" id="codcliente"><input class="form-control" type="text" name="busquedacliente" id="busquedacliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Datos del Cliente para tu busqueda" required="required">
...
<button type="button" onClick="BuscaCreditosClientes()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
						        ...
						        <div id="muestracreditosclientes"></div>
						          </form>
           </div>
       </div>
</div>
