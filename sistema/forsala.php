...
{
$reg = $tra->RegistrarSalas();
exit;
} 
else if(isset($_POST['btn-update']))
{
$reg = $tra->ActualizarSalas();
exit;
}
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Salas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="salas">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Salas</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			
<?php  if (isset($_GET['codsala'])) {
			
			$reg = $tra->SalasPorId(); ?>
			
<form class="form" name="updatesalas" id="updatesalas" method="post" data-id="<?php echo $reg[0]["codsala"] ?>" action="#">
				
		<?php } else { ?>
				
		<form class="form" method="post"  action="#" name="salas" id="salas">	
 ...
 <input type="hidden" name="codsala" id="codsala" <?php if (isset($reg[0]['codsala'])) { ?> value="<?php echo $reg[0]['codsala']; ?>"<?php } ?>>
 <input type="text" class="form-control" name="nombresala" id="nombresala" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Sala" <?php if (isset($reg[0]['nombresala'])) { ?> value="<?php echo $reg[0]['nombresala']; ?>"<?php } ?> required="" aria-required="true">
