...
else if(isset($_POST['btn-ingrediente']))
{
$reg = $tra->CargarIngredientes();
exit;
}
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Carga Masiva</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="cargamasiva">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Carga Masiva de Productos</h3></div>
...
<form class="form" method="post"  action="#" name="cargaproductos" id="cargaproductos" enctype="multipart/form-data">
...
<label class="control-label">Cargar Archivo (CSV Delimitado por comas): <span class="symbol required"></span></label>
<input type="file" class="file" size="10" data-original-title="Seleccione Archivo" data-rel="tooltip" placeholder="Suba su Archivo" name="sel_file" id="sel_file"/>
<small><p>Para realizar la Carga masiva de Beneficiarios el archivo debe de ser extensión (CSV Delimitado por Comas). <br></small>
                              </div> 
                        </div>
...
<button type="submit" name="btn-producto" id="btn-producto" class="btn btn-primary"><span class="fa fa-cloud-upload"></span> Cargar Productos</button>     
...
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Carga Masiva de Ingredientes</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
             
<form class="form" method="post"  action="#" name="cargaingredientes" id="cargaingredientes" enctype="multipart/form-data">
      
                                                  <div id="erroringrediente">
                                                 <!-- error will be shown here ! -->
                                                  </div>
...
<label class="control-label">Cargar Archivo (CSV Delimitado por comas): <span class="symbol required"></span></label>
<input type="file" class="file" size="10" data-original-title="Seleccione Archivo" data-rel="tooltip" placeholder="Suba su Archivo" name="sel_file" id="sel_file"/>
<small><p>Para realizar la Carga masiva de Familiares el archivo debe de ser extensión (CSV Delimitado por Comas). <br></small>
                              </div> 
                        </div>
            ...
            <div class="modal-footer"> 
<button type="submit" name="btn-ingrediente" id="btn-ingrediente" class="btn btn-primary"><span class="fa fa-cloud-upload"></span> Cargar Ingredientes</button>      
<button type="button" onClick="CargaDivIngrediente()" class="btn btn-info"><span class="fa fa-eye"></span> Ver Detalles</button> 
                          </div>
                                </form>
                                    </div><!-- /.box-body -->
                </div>
