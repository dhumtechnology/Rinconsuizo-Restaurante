...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Arqueos de Cajas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="arqueoscajas">Control</a></li>
<li class="active">Arqueos de Cajas</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post" action="#" name="buscaarqueosfechas" id="buscaarqueosfechas">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Arqueos de Cajas</h3></div>
...
<button type="button" onClick="BuscaArqueosCajasFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
                                    </div><!-- /.box-body -->
								</div>
                          </div>
						        ...
						        <div id="muestraarqueosfechas"></div>
						          </form>
           </div>
       </div>
</div>
