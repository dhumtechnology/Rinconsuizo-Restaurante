...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
            <h3 class="panel-title"><i class="fa fa-align-justify"></i> Detalle y Movimientos del Ingrediente</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestraingredientemodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Ingredientes</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Ingredientes</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Ingredientes<span class="pull-right">
...
<li><a href="foringrediente" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Ingrediente"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("INGREDIENTES") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado Pdf"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("INGREDIENTESSTOCK") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Stock Minimo Pdf"><i class="fa fa-file-pdf-o"></i> Stock M. (Pdf)</a></li>
<li><a href="reporteexcel?tipo=<?php echo base64_encode("INGREDIENTES") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado Excel"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span>
</h3>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTE INGREDIENTE NO PUEDE SER ELIMINADO, TIENE PRODUCTOS ASOCIADAS ACTUALMENTE</center>";
        echo "</div>";   
		break;
		...
		echo "<div class='alert alert-warning'>";
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR INGREDIENTES, NO ERES EL ADMINISTRADOR DEL SISTEMA</center>";
        echo "</div>";   
		break;
...
?>
											   ...
											   <td><?php echo "<strong>".$config[0]['simbolo']."</strong>".$reg[$i]['costoingrediente']; ?></td>
											   <td>
 
<a href="#" class="btn btn-success btn-xs" onClick="VerIngrediente('<?php echo base64_encode($reg[$i]['codingrediente']) ?>')" data-href="#" data-toggle="modal" data-target=".bs-example-modal-lg" data-placement="left" data-backdrop="static" data-keyboard="false" data-id="" rel="tooltip" data-original-title="Ver Ingrediente" title="Ver Ingrediente"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Ingrediente" onClick="actualizar('foringrediente?codingrediente=<?php echo base64_encode($reg[$i]["codingrediente"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Ingrediente" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codingrediente=<?php echo base64_encode($reg[$i]["codingrediente"]) ?>&tipo=<?php echo base64_encode("INGREDIENTES") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
