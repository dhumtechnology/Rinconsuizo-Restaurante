...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Informe General de Ventas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="ventas">Control</a></li>
<li class="active">Informe General de Ventas</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post" action="#" name="buscainformeventasfechas" id="buscainformeventasfechas">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Informe General de Ventas</h3></div>
...
<input class="form-control calendario" type="text" name="desde" id="desde" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha de Inicio para tu Búsqueda" required="" aria-required="true">
...
<input class="form-control calendario" type="text" name="hasta" id="hasta" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha Final para tu Búsqueda" required="" aria-required="true">
                        <i class="fa fa-calendar form-control-feedback"></i> 
                              </div> 
                        </div> 
                    </div><br>
...
<button type="button" onClick="BuscaInformeVentasFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
                                    </div><!-- /.box-body -->
								</div>
                          </div>
						        ...
						        <div id="muestrainformeventasfechas"></div>
						          </form>
           </div>
       </div>
</div>
