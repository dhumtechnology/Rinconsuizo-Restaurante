...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Compras</h4>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Compras</h3>
</div>
