...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Ventas por Cajas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="ventas">Control</a></li>
<li class="active">Ventas por Cajas</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post" action="#" name="buscaventascajas" id="buscaventascajas">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Ventas por Cajas</h3></div>
...
<button type="button" onClick="BuscaVentasCajas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
                                    </div><!-- /.box-body -->
								</div>
                          </div>
