...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Categorias</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="categorias">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Categorias</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			
<?php  if (isset($_GET['codcategoria'])) {
			
			$reg = $tra->CategoriasPorId(); ?>
			
      <form class="form" name="updatecategoria" id="updatecategoria" method="post" data-id="<?php echo $reg[0]["codcategoria"] ?>" action="#">
				
		<?php } else { ?>
				
		<form class="form" method="post"  action="#" name="categorias" id="categorias">	
...
<input type="hidden" name="codcategoria" id="codcategoria" <?php if (isset($reg[0]['codcategoria'])) { ?> value="<?php echo $reg[0]['codcategoria']; ?>"<?php } ?>>
  <input type="text" class="form-control" name="nomcategoria" id="nomcategoria" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Categoria" <?php if (isset($reg[0]['nomcategoria'])) { ?> value="<?php echo $reg[0]['nomcategoria']; ?>"<?php } ?> required="" aria-required="true">
