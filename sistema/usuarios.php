...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
    <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos del Usuario</h3> 
                                                        </div> 
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Usuarios</h4>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Usuarios<span class="pull-right">
...
<li><a href="forusuario" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Usuario"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("USUARIOS") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?tipo=<?php echo base64_encode("USUARIOS") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3></div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> EL USUARIO FUE ELIMINADO EXITOSAMENTE </center>"; 
		echo "</div>";
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTE USUARIO NO PUEDE SER ELIMINADO, TIENE VENTAS ASOCIADAS ACTUALMENTE </center>";  
		echo "</div>"; 
		break;
...
?>
											   ...
											   <td><?php echo $status = ( $reg[$i]['status'] == 'ACTIVO' ? "<span class='label label-success'><i class='fa fa-check'></i> ".$reg[$i]['status']."</span>" : "<span class='label label-warning'><i class='fa fa-times'></i> ".$reg[$i]['status']."</span>"); ?></td>
											   <td>
 
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Usuario" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerUsuario('<?php echo base64_encode($reg[$i]["codigo"]); ?>')"><i class="fa fa-search-plus"></i></a>

<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="No tiene permisos" ><i class="fa fa-pencil"></i></a>

<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="No tiene permisos" ><i class="fa fa-trash-o"></i></a>

<!--								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Usuario" onClick="actualizar('forusuario?codigo=<?php echo base64_encode($reg[$i]["codigo"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Usuario" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codigo=<?php echo base64_encode($reg[$i]["codigo"]) ?>&tipo=<?php echo base64_encode("USUARIOS") ?>')"><i class="fa fa-trash-o"></i></a>
--></td>
											   </tr>
											   <?php } } ?>
											   </tbody>
