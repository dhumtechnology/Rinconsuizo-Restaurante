...
<div  class="col-md-8 col-md-offset-3">
  ...
  <?php if(isset($_SESSION["id_cliente"]) ):?>  
        ...
        <h1 style="background-color: var(--brand-accent);
    padding: 10px 10px;
    border-radius: 30px;
    color: white;">HOLA, 
            ...
            <section id="main">
              ...
              <section>
                  ...
                  <div class="form-group row ">
                      ...
                      <div class="col-md-8">
                            <div class="input-group js-parent-focus">
                              <input class="form-control js-child-focus js-visible-password" name="documento" type="text" value="<?php echo $cliente->cedcliente;?>" required placeholder="Ejem: 909238823">
                            </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group row ">
                      ...
                      <div class="col-md-8">
                            <div class="input-group js-parent-focus">
                              <input class="form-control js-child-focus js-visible-password" name="nombre" type="text" value="<?php echo $cliente->nomcliente;?>" required>
                            </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group row ">
                      ...
                      <div class="col-md-8">
                            <div class="input-group js-parent-focus">
                              <input class="form-control js-child-focus js-visible-password" name="direccion" type="text" value="<?php echo $cliente->direccliente;?>" required>
                            </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group row ">
                    ...
                    <div class="col-md-8">
                          <input class="form-control" name="celular" type="text" value="<?php echo $cliente->tlfcliente;?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row ">
                    ...
                    <div class="col-md-8">
                          <input class="form-control" name="email" type="email" value="<?php echo $cliente->emailcliente;?>" required>
                    </div>
                  </div>
              ...
              <footer class="form-footer text-sm-center clearfix">
                <input type="hidden" name="submitLogin" value="1">
                  <button id="submit-login" name="btn_send" class="btn btn-primary" data-link-action="sign-in" type="submit" class="form-control-submit">
                    Actualizar
                  </button>
