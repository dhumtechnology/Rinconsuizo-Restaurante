...
<aside id="notifications">
  ...
  <!--page name-->
      <p class="breadcrumb-page-name hidden-sm-down">Reservas para tu hora de llegada</p>
    <!--end page name-->
  ...
  <h4>Información</h4>
    ...
    <div class="block">
      ...
      <div class="data email">
       Revisar:<br/>
       <a href="">Revisa su correo electrónico para confirmar la reserva.</a>
       </div>
    </div>
  </div>
  ...
  <form action="addreserva.php" method="post" enctype="multipart/form-data">

    <?php if(isset($_SESSION["id_cliente"]) ):?>
    <section class="form-fields">
        <div class="form-group row">
          <div class="col-md-9 col-md-offset-3">
            <h3>Datos a envíar</h3>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <input class="form-control js-child-focus js-visible-password" name="nombre" type="text" value="<?php echo $cliente->nomcliente;?>" required placeholder="Ejem: Juan Carlos Zambrano">
          </div>
        </div>
        ...
        <div class="form-group row">
          <label class="col-md-3 form-control-label">Cantidad de personas</label>
          <div class="col-md-6">
            <input class="form-control js-child-focus js-visible-password" name="cantidad" type="text" value="" required placeholder="Eje. 4">
          </div>
        </div>

        <div class="form-group row">
          <label class="col-md-3 form-control-label">Fecha de llegada</label>
          <div class="col-md-6">
            <input class="form-control js-child-focus js-visible-password" name="fecha" type="date" value="" required >
          </div>
        </div>

        <div class="form-group row">
          <label class="col-md-3 form-control-label">Hora aproximado de llegada</label>
          <div class="col-md-6">
            <input class="form-control js-child-focus js-visible-password" name="hora" type="time" value="" required >
          </div>
        </div>
      ...
      <footer class="form-footer text-sm-right">
        ...
        <input class="btn btn-outline" type="submit" name="submitMessage" value="Enviar reserva">
      </footer>
        <?php else:?>

        <h4 class='alert alert-danger'>Necesita iniciar sesión para continuar <a href="micuenta.php"> Iniciar sesión</a></h4>
       <?php endif;?>
